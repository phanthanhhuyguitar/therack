        ...
        <div class="row m-0 p-0">
          <div class="col-4 promo-info h-100">
            <div class="infowrapper d-flex flex-column h-100 justify-content-center">
              <h2>CHỌN TỪ TRANG CHỦ</h2>
              <h4>30% tất cả sản phẩm</h4>
              <p>Sale hết tháng 12</p>
              <a href="{{ route('product.index') }}" class="w-100 button">MUA NGAY</a>
            </div>
          </div>
        </div>
    ...
    <!-- MEN & WOMEN [E]-->
        ...
        <div class="row m-0 pt-4">
          <div class="col-lg-4 col-sm-12 d-flex flex-column align-items-center categorywrapper">
            <a href="{{ route('product.index') }}">
              <div class="category">
                <img class="" height="200px" src="{{ asset('photo/watch.jpg') }}" alt="">
                <h5 class="pt-2">ĐỒNG HỒ</h5>
              </div>
            </a>
          </div>
          <div class="col-lg-4 col-sm-12 d-flex flex-column align-items-center categorywrapper">
            <a href="#">
              <div class="category">
                <img class="" height="200px" src="{{ asset('photo/perfume.jpg') }}" alt="">
                <h5 class="pt-2">NƯỚC HOA</h5>
            </div>
            </a>
          </div>
          <div class="col-lg-4 col-sm-12 d-flex flex-column align-items-center categorywrapper">
            <a href="#">
              <div class="category">
                <img class="" height="200px" src="{{ asset('photo/fashion.jpg') }}" alt="">
                <h5 class="pt-2">FASHION</h5>
              </div>
            </a>
          </div>
        </div>
