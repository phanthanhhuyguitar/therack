                        ...
                        @foreach ($products as $product)
                            <div class="col-12 d-flex p-2 justify-content-between cart-item">
                                ...
                                <div class="item-detail mr-auto d-flex flex-column justify-content-center">
                                    ...
                                    <div class="info-4"><h6>Số lượng: {{ $product['quantity'] }}</h6></div>
                                    <div class="info-5">
                                ...
                                <div class="item-quantity">{{ $product['price'] }}đ</div>
                            </div>
                        @endforeach
                    </div>
                        ...
                        <div class="card-body">
                            <div class="cart-checkout">
                                ...
                                <div class="info-4 pt-3">
                                    <a href="{{ route('product.index') }}"><button class="button w-100">TIẾP TỤC MUA</button></a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container p-0 ">
        <div class="row">
            <div class="col-12 d-flex flex-column justify-content-center align-items-center empty-cart">
                ...
                <div><h4><b>Giõ hàng của bạn trống</b></h4></div>
                <div><a href="{{ route('product.index') }}">Mua một vài đôi giày trước :)</a></div>
            </div>
        </div>
    </div>
