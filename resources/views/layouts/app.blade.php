        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    <div class="d-flex">
                        <div><img src="{{ asset('photo/logo.svg') }}" style="height:50px;" alt=""></div>
                        <div class="pl-3 ml-3 pt-2" style="border-left:1px solid rgba(0, 0, 0, 0.5); font-size:1.5rem;">Watch</div>
                    </div>
                </a>
                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    <a href="{{ route('profile.edit',['user'=>Auth::user()->id ]) }}" class="dropdown-item">Sửa Profile</a>
            ...
            <div class='container p-0 pt-3'>
                <div class='row'>
                    ...
                    <div class='col-md-4 col-sm-12 pt-3'>
                        ...
                        <div class='newsletter-form p-0'>
                            <form action='{{ route('newsletter.add') }}' method='post' id='newsletter-validate-detail'>
                                ...
                                <button type='submit' id='signup-newsletter-footer' class='button'>ĐĂNG KÍ</button>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class='col-md-6 col-sm-12 copyright'>
                        <p>Designed from scratch by thanhhuygt</p>
                        <p>thgt &copy; 2019. All Rights Reserved</p>
                    </div>
